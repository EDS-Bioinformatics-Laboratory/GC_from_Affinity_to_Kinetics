...
//     trackball(curent_quaternion, 0.0, 0.0, 0.0, -1.0);
...
//             }
//             
//             else if(currCB->cell_type == Centrocyte)
//             {
////                 glColor4f(0.0, 0.1, 0.25, 0.4);
...
////
////             glutSolidCube(sizeSphere);         //   I think this way you can draw cubes!!
////             glTranslatef(-currFDC->position.X + XWidth / 2., -currFDC->position.Y +YWidth / 2., -currFDC->position.Z + ZWidth / 2.);
//
...
//                 double AgC=currentSpace->FDC_Ag_grid.at(currFDC->occupiedPositions[fr].X).at(currFDC->occupiedPositions[fr].Y).at(currFDC->occupiedPositions[fr].Z).second.second;
//                 
//                 glColor4f( AgC/AgC,1.0/AgC, 1./AgC,  .5);
...
////                 bool res = loadOBJ("dcell.obj", vertices, uvs, normals);
