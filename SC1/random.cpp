...
double random::cell_cycle_time (double i, int current_cycle)
{
    ...
    double arg;
    double thisphase = i;
    double width = 1. * double(thisphase);
...
double random::randomDouble(double fMin, double fMax)
{
...
double random::randomNormaldouble(double a,double b)
{
    std::normal_distribution<long double> distribution(a,b);
    long double number =0.0L;
    number = distribution(generator);
    return number;

}
int random::randomNormalint(int a, int b){
    std::normal_distribution<double> distribution(a,b);
    int number2 = std::round(distribution(generator));
    return number2;
}

double random::randomWeibull(double a, double b)
{
